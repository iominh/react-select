...
var Select = _react2['default'].createClass({
	...
	propTypes: {
		...
		autoTokenize: _react2['default'].PropTypes.object, // whether to automatically tokenize values
	...
	handleKeyDown: function handleKeyDown(event) {
		var autoTokenize = this.props.autoTokenize;
	...
	handleTokenization: function handleTokenization() {
